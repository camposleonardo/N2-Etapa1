...
void main() => runApp(Cinzeiro2());

class Cinzeiro2 extends StatefulWidget {
  const Cinzeiro2({Key key}) : super(key: key);

  @override
  _Cinzeiro2State createState() => _Cinzeiro2State();
}

class _Cinzeiro2State extends State<Cinzeiro2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/cinzeiro 2.jpg"),
                        ],
                      ),
                    ),
                  ],
