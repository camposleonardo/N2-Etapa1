...
void main() => runApp(Bebida6());

class Bebida6 extends StatefulWidget {
  const Bebida6({Key key}) : super(key: key);

  @override
  _Bebida6State createState() => _Bebida6State();
}

class _Bebida6State extends State<Bebida6> {
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:Column(
                children:<Widget>[
                  Text("Marca: Jack Daniels Black \n\nSabor: Original\n\nTeor alcoólico: 48 Percent by Volume\n\nTipo de álcool: Wisky\n\nInformações adicionais:  ")
                ],
              ),
            ),
