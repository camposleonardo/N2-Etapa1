...
void main() => runApp(Isqueiro2());

class Isqueiro2 extends StatefulWidget {
  const Isqueiro2({Key key}) : super(key: key);

  @override
  _Isqueiro2State createState() => _Isqueiro2State();
}

class _Isqueiro2State extends State<Isqueiro2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/isqueiro 2.png"),
                        ],
                      ),
                    ),
                  ],
