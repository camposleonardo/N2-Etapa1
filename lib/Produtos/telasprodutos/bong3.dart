...
void main() => runApp(Bong3());

class Bong3 extends StatefulWidget {
  const Bong3({Key key}) : super(key: key);

  @override
  _Bong3State createState() => _Bong3State();
}

class _Bong3State extends State<Bong3> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/bong 3.png"),
                        ],
                      ),
                    ),
                  ],
