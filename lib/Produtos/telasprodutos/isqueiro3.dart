...
void main() => runApp(Isqueiro3());

class Isqueiro3 extends StatefulWidget {
  const Isqueiro3({Key key}) : super(key: key);

  @override
  _Isqueiro3State createState() => _Isqueiro3State();
}

class _Isqueiro3State extends State<Isqueiro3> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/isqueiro 3.png"),
                        ],
                      ),
                    ),
                  ],
            ...
            Text("Isqueiro Elétrico Simples"),
            Text("Por: R 79,90 "),
            Wrap(
              children: <Widget>[
