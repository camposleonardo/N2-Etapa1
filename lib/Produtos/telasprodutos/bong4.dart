...
void main() => runApp(Bong4());

class Bong4 extends StatefulWidget {
  const Bong4({Key key}) : super(key: key);

  @override
  _Bong4State createState() => _Bong4State();
}

class _Bong4State extends State<Bong4> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/bong 4.png"),
                        ],
                      ),
                    ),
                  ],
