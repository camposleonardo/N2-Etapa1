...
void main() => runApp(Seda4());

class Seda4 extends StatefulWidget {
  const Seda4({Key key}) : super(key: key);

  @override
  _Seda4State createState() => _Seda4State();
}

class _Seda4State extends State<Seda4> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/seda 4.png"),
                        ],
                      ),
                    ),
                  ],
