...
void main() => runApp(Dichavador2());

class Dichavador2 extends StatefulWidget {
  const Dichavador2({Key key}) : super(key: key);

  @override
  _Dichavador2State createState() => _Dichavador2State();
}

class _Dichavador2State extends State<Dichavador2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/dichavador 2.jpg"),
                        ],
                      ),
                    ),
                  ],
