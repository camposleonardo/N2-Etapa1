...
void main() => runApp(Cinzeiro1());

class Cinzeiro1 extends StatefulWidget {
  const Cinzeiro1({Key key}) : super(key: key);

  @override
  _Cinzeiro1State createState() => _Cinzeiro1State();
}

class _Cinzeiro1State extends State<Cinzeiro1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/cinzeiro 1.jpg"),
                        ],
                      ),
                    ),
                  ],
