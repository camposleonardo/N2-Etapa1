...
void main() => runApp(Bong2());

class Bong2 extends StatefulWidget {
  const Bong2({Key key}) : super(key: key);

  @override
  _Bong2State createState() => _Bong2State();
}

class _Bong2State extends State<Bong2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/bong 2.png"),
                        ],
                      ),
                    ),
                  ],
