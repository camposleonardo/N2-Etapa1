...
void main() => runApp(Seda1());

class Seda1 extends StatefulWidget {
  const Seda1({Key key}) : super(key: key);

  @override
  _Seda1State createState() => _Seda1State();
}

class _Seda1State extends State<Seda1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/seda 1.png"),
                        ],
                      ),
                    ),
                  ],
