...
void main() => runApp(Pipes3());

class Pipes3 extends StatefulWidget {
  const Pipes3({Key key}) : super(key: key);

  @override
  _Pipes3State createState() => _Pipes3State();
}

class _Pipes3State extends State<Pipes3> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/pipes 3.jpg"),
                        ],
                      ),
                    ),
                  ],
