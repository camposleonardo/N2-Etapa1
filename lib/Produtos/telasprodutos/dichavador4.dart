...
void main() => runApp(Dichavador4());

class Dichavador4 extends StatefulWidget {
  const Dichavador4({Key key}) : super(key: key);

  @override
  _Dichavador4State createState() => _Dichavador4State();
}

class _Dichavador4State extends State<Dichavador4> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/dichavador 4.jpg"),
                        ],
                      ),
                    ),
                  ],
