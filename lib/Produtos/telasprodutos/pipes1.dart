...
void main() => runApp(Pipes1());

class Pipes1 extends StatefulWidget {
  const Pipes1({Key key}) : super(key: key);

  @override
  _Pipes1State createState() => _Pipes1State();
}

class _Pipes1State extends State<Pipes1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/pipes 1.png"),
                        ],
                      ),
                    ),
                  ],
