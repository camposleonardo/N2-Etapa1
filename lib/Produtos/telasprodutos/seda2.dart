...
void main() => runApp(Seda2());

class Seda2 extends StatefulWidget {
  const Seda2({Key key}) : super(key: key);

  @override
  _Seda2State createState() => _Seda2State();
}

class _Seda2State extends State<Seda2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/seda 2.png"),
                        ],
                      ),
                    ),
                  ],
