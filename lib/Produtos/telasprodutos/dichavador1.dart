...
void main() => runApp(Dichavador1());

class Dichavador1 extends StatefulWidget {
  const Dichavador1({Key key}) : super(key: key);

  @override
  _Dichavador1State createState() => _Dichavador1State();
}

class _Dichavador1State extends State<Dichavador1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/dichavador 1.jpg"),
                        ],
                      ),
                    ),
                  ],
