...
void main() => runApp(Isqueiro5());

class Isqueiro5 extends StatefulWidget {
  const Isqueiro5({Key key}) : super(key: key);

  @override
  _Isqueiro5State createState() => _Isqueiro5State();
}

class _Isqueiro5State extends State<Isqueiro5> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/isqueiro 5.jpg"),
                        ],
                      ),
                    ),
                  ],
