...
void main() => runApp(Dichavador5());

class Dichavador5 extends StatefulWidget {
  const Dichavador5({Key key}) : super(key: key);

  @override
  _Dichavador5State createState() => _Dichavador5State();
}

class _Dichavador5State extends State<Dichavador5> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/dichavador 5.jpeg"),
                        ],
                      ),
                    ),
                  ],
