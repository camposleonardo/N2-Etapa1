...
void main() => runApp(Dichavador3());

class Dichavador3 extends StatefulWidget {
  const Dichavador3({Key key}) : super(key: key);

  @override
  _Dichavador3State createState() => _Dichavador3State();
}

class _Dichavador3State extends State<Dichavador3> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/dichavador 3.jpg"),
                        ],
                      ),
                    ),
                  ],
