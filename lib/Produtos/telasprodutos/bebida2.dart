...
void main() => runApp(Bebida2());

class Bebida2 extends StatefulWidget {
  const Bebida2({Key key}) : super(key: key);

  @override
  _Bebida2State createState() => _Bebida2State();
}

class _Bebida2State extends State<Bebida2> {
  @override
