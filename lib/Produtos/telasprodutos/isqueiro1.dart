...
void main() => runApp(Isqueiro1());

class Isqueiro1 extends StatefulWidget {
  const Isqueiro1({Key key}) : super(key: key);

  @override
  _Isqueiro1State createState() => _Isqueiro1State();
}

class _Isqueiro1State extends State<Isqueiro1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/isqueiro 1.png"),
                        ],
                      ),
                    ),
                  ],
