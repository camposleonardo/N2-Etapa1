...
void main() => runApp(Bandeja1());

class Bandeja1 extends StatefulWidget {
  const Bandeja1({Key key}) : super(key: key);

  @override
  _Bandeja1State createState() => _Bandeja1State();
}

class _Bandeja1State extends State<Bandeja1> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/bandeja 1.jpeg"),
                        ],
                      ),
                    ),
                  ],
