...
void main() => runApp(Isqueiro4());

class Isqueiro4 extends StatefulWidget {
  const Isqueiro4({Key key}) : super(key: key);

  @override
  _Isqueiro4State createState() => _Isqueiro4State();
}

class _Isqueiro4State extends State<Isqueiro4> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/isqueiro 4.png"),
                        ],
                      ),
                    ),
                  ],
