...
void main() => runApp(Pipes2());

class Pipes2 extends StatefulWidget {
  const Pipes2({Key key}) : super(key: key);

  @override
  _Pipes2State createState() => _Pipes2State();
}

class _Pipes2State extends State<Pipes2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/pipes 2.png"),
                        ],
                      ),
                    ),
                  ],
