...
void main() => runApp(Bandeja2());

class Bandeja2 extends StatefulWidget {
  const Bandeja2({Key key}) : super(key: key);

  @override
  _Bandeja2State createState() => _Bandeja2State();
}

class _Bandeja2State extends State<Bandeja2> {
  @override
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset("imagens/bandeja 2.jpg"),
                        ],
                      ),
                    ),
                  ],
